          ...
          appBar: AppBar(
            ...
            title: RichText(
              ...
              text: TextSpan(children: [
                TextSpan(text: ctrl.userNamGet, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 28.sp, color: AppColors.textColor)),
              ]),
              maxLines: 1,
            ),
            actions: [
                              ...
                              return TransactionTile(
                                ...
                                leadingOnTap: () {
                                  twoFunctionAlert(
                                      context: context,
                                      onTap: () {
                                        ctrl.deleteCreditDebit(ctrl.allCreditDebit[index].crUserId ?? -1, ctrl.allCreditDebit[index].creditDebitId ?? -1);
                                      },
                                      onCancelTap: () {},
