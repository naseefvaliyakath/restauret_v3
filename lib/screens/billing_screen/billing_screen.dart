  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        ...
        if (Get.find<BillingScreenController>().isNavigateFromKotUpdate == true) {
          return true;
        } else {
          //? checking if any bill added in the list
          if (Get.find<BillingScreenController>().billingItems.isNotEmpty) {
                  ...
                  children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      WhiteButtonWithIcon(
                        text: ctrl.orderType == HOME_DELEVERY
                            ? (ctrl.selectDeliveryAddrTxt.length > 12
                                ? ctrl.selectDeliveryAddrTxt.substring(0, 13)
                                : ctrl.selectDeliveryAddrTxt)
                            : ctrl.orderType == DINING
                                ? ctrl.selectTableTxt
                                : ctrl.orderType == ONLINE
                                    ? (ctrl.selectedOnlineAppNameTxt.length > 12
                                        ? ctrl.selectedOnlineAppNameTxt.substring(0, 13)
                                        : ctrl.selectedOnlineAppNameTxt)
                                    : 'Take away',
                        icon: Icons.edit,
                        onTap: () {
                    ...
                    Container(
                      decoration: BoxDecoration(
                          border: Border.all(color: AppColors.mainColor), borderRadius: BorderRadius.circular(5.r)),
                                      ...
                                      onTap: () async {
                                        ...
                                        if (ctrl.isClickedSettle.value) {
                                          AppSnackBar.errorSnackBar(
                                              'This bill is already settled', 'Click new order !');
