            ...
            child: Column(
              children: [
                ...
                ProfileMenu(
                  ...
                  press: () {
                    Get.toNamed(RouteHelper.getVideoPlayScreen(),arguments: {'link':'t0Q2otsqC4I','name':'Dash bord screen'});
                  },
                ),
                ProfileMenu(
                  text: "Billing screen",
                  icon: Icons.ondemand_video_rounded,
                  press: () {
                    Get.toNamed(RouteHelper.getVideoPlayScreen(),arguments: {'link':'wEz5jejK3aw','name':'Billing screen'});
                  },
                ),
              ],
            ),
