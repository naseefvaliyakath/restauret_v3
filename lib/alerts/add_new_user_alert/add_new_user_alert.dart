...
void addNewUserAlert({required BuildContext context}) {
  try {
    showAnimatedDialog(
      context: context,
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: const Center(child: BigText(text: 'Enter Name')),
          content: const SingleChildScrollView(child: AddNewUserAlertBody()),
        );
      },
